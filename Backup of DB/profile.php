						...
						while($bkg=mysqli_fetch_array($bk))
						{
							...
							<tr>
								...
								<td>
									...
									{?>
									<button data-toggle="modal"  data-target="#cancel" class="btn btn-danger btn-sm" data-toggle="modal"><i class="fa fa-trash"></i> <a style="color:red;     text-decoration: none;
